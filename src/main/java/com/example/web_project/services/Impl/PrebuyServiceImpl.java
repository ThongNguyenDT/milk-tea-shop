...
public class PrebuyServiceImpl implements PrebuyService {
    ...
    public void addToOrder(int idProduct, int count, int idSize, int idAddin, int idFoam, int idTopping, int idAccount) {
        ...
        if (existingBill != null) {
            ...
            createBillInfo(existingBill, idProduct, count, idDrinkType);
        } else {
            ...
            createBillInfo(newBill, idProduct, count, idDrinkType);
        }
    }

    private void createBillInfo(Bill bill, int idProduct, int count, int idDrinkType) {
        ...
        Drinkcost drinkCost = drinkCostRepository.findById(idDrinkType).orElse(null);
