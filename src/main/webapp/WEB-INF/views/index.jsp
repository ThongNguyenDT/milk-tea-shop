...
<body>
  <div class="body-wrap">
        ...
        <div class="row d-flex align-items-center container-md">
          <div class="col col-sm-12 col-md-8 col-xxl-6 left_content">
            ...
            <div class="textbox">
              ...
              <p class="">Welcome to our milk tea paradise, where every sip is a journey to flavor nirvana. Dive into
                the
                world of
                perfectly brewed tea leaves, infused with velvety milk and a touch of sweetness, and discover the magic
                of
                milk tea like never before.</p>
              <div class="shop_btn">
                <button class="Btn_hover">
                  SHOP NOW
                </button>
              </div>
            </div>
        ...
        <div class="container-md">
          <div class="row">
            ...
            <div class="col-sm-4 text">
              <h1>Why <br> choose <strong><span style="color: #c3917d;">Our</span></strong> <br> <strong>Milk
                  Tea</strong>?</h1>
              <h2>
                <strong>Premium Ingredients:</strong> We source the finest tea leaves and highest-quality milk to create
                a luxurious
                blend that's simply irresistible.
              </h2>
              <h2>
                <strong>Endless Variety:</strong> Explore a wide range of flavors, from classic black and green teas to
                exotic fruit infusions, all expertly crafted to tantalize your taste buds.
              </h2>
              <h2>
                <strong>Customization:</strong> Personalize your milk tea experience with options for sweetness levels
                and toppings,
                ensuring each cup is tailored to your preferences.
              </h2>
              <h2>
                <strong>Quality Assurance:</strong> Our commitment to excellence means you can count on consistently
                delicious milk tea,
                every single time.
              </h2>
            </div>
    ...
    <section class="sec_3 cus-fullpage">
      <div class="cus-fullpage-box">
        <div class="cus-fullpage-items">
          <div class="container d-flex align-items-center">
            <div class="row">
              <div class="col-3 col-xl-6"></div>
              <div class="sec3__content col-12 col-xl-6">
                <div class="sec3__content__textbox col-11 col-sm-7 col-lg-9  ">
                  <h1>Uncompromising Quality </h1>
                  <p>We are committed to sourcing the finest tea leaves and
                    freshest milk available. Our dedication to quality ensures that every cup of milk tea is an
                    embodiment
                    of perfection. We believe that the best ingredients make the best tea. </p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="sec3__content col-12 col-xl-6">
                <div class="sec3__content__textbox col-11 col-sm-7 col-lg-9  ">
                  ...
                  <p>Our tea artisans are masters of their craft. They
                    carefully
                    brew and blend each batch of tea with precision and passion, delivering a symphony of flavors that
                    dance on your palate. It's not just a drink; it's a work of art.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="cus-fullpage-items">
          <div class="container d-flex align-items-center">
            <div class="row">
              ...
              <div class="sec3__content col-12 col-xl-6">
                <div class="sec3__content__textbox col-11 col-sm-7 col-lg-9  ">
                  <h1>Flavor Exploration </h1>
                  <p>We encourage you to embark on a flavor journey like no other.
                    From classic to innovative, our menu boasts a wide spectrum of choices to cater to diverse tastes.
                    Try
                    our seasonal and specialty creations that push the boundaries of what milk tea can be.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="cus-fullpage-items">
          <div class="container d-flex align-items-center">
            <div class="row">
              ...
              <div class="sec3__content col-12 col-xl-6">
                <div class="sec3__content__textbox col-11 col-sm-7 col-lg-9  ">
                  <h1>Customization Without Compromise </h1>
                  <p>We understand that individual preferences vary.
                    That's why we offer the flexibility to customize your milk tea experience. Adjust the sweetness
                    level, choose from a variety of toppings, and make it uniquely yours.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="cus-fullpage-items">
          <div class="container d-flex align-items-center">
            <div class="row">
              ...
              <div class="sec3__content col-12 col-xl-6">
                <div class="sec3__content__textbox col-11 col-sm-7 col-lg-9  ">
                  <h1>Community and Culture </h1>
                  <p>We are more than a place to grab a drink; we're a community
                    hub. We celebrate the rich cultural heritage of tea and create a welcoming space for people to
                    connect, relax, and savor the moment. Join us for events, workshops, and tea tastings that deepen
                    your appreciation for this timeless beverage.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="sec3__content col-12 col-xl-6">
                <div class="sec3__content__textbox col-11 col-sm-7 col-lg-9  ">
                  ...
                  <p>We are passionate about sustainability. We take steps
                    to reduce our environmental footprint, from eco-friendly packaging to supporting ethical sourcing
                    practices. When you choose our milk tea, you're not just indulging; you're contributing to a better
                    planet.</p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="sec3__content col-12 col-xl-6">
                <div class="sec3__content__textbox col-11 col-sm-7 col-lg-9  ">
                  ...
                  <p>Our friendly and knowledgeable staff are here to guide you
                    through our menu, provide recommendations, and ensure that your milk tea experience is nothing short
                    of exceptional. We take pride in serving you with a smile.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="cus-fullpage-position">
        <a onclick="myFunction(0)" class="cur-position">
          <p>Uncompromising Quality</p>
          <i class="fa-solid fa-leaf"></i>
        </a>
        <a onclick="myFunction(1)" class="cur-position">
          <p>Artisanal Craftsmanship</p>
          <i class="fa-solid fa-leaf"></i>
        </a>
        <a onclick="myFunction(2)" class="cur-position">
          <p>Flavor Exploration</p>
          <i class="fa-solid fa-leaf"></i>
        </a>
        <a onclick="myFunction(3)" class="cur-position">
          <p>Customization Without Compromise</p>
          <i class="fa-solid fa-leaf"></i>
        </a>
        <a onclick="myFunction(4)" class="cur-position">
          <p>Community and Culture</p>
          <i class="fa-solid fa-leaf"></i>
        </a>
        <a onclick="myFunction(5)" class="cur-position">
          <p>Sustainability Commitment</p>
          <i class="fa-solid fa-leaf"></i>
        </a>
        <a onclick="myFunction(6)" class="cur-position">
          ...
          <div class="col-12 d-flex justify-content-center">
            <div class="content d-block d-lg-flex">
              <div class="col-12 col-lg-6">
                <img class="img-fluid" src="https://i.pinimg.com/564x/1b/2a/28/1b2a28de265557e4ed34c21c8ded3b65.jpg"
                  alt="ABOUT us">
              </div>
              <div class="col-12 col-lg-6 ps-3 pe-5 d-flex flex-column justify-content-between">
                <div class="textbox">
                  <h1>ABOUT US</h1>
                  <p>We're your go-to destination for the perfect milk tea experience. With a passion for crafting the
                    finest tea blends, premium milk, and irresistible flavors, we're dedicated to delivering joy, one
                    cup at a time. Join us in celebrating the magic of milk tea and explore our world of taste,
                    tradition, and innovation. Your happiness is our priority, and we can't wait to serve you your next
                    favorite milk tea.</p>
                </div>
      ...
      <div class="more">
        <div class="row">
          <div class="d-flex gap-3 flex-wrap justify-content-center">
            <div class="image">
              <img src="https://i.pinimg.com/236x/49/fe/ed/49feedff98cd38963f2cf9991f91aad2.jpg" alt="more">
            </div>
            <div class="image">
              <img src="https://i.pinimg.com/236x/00/5c/cd/005ccd9267823c57bb3fc032d484cd6f.jpg" alt="more">
            </div>
            <div class="image">
              <img src="https://i.pinimg.com/236x/23/b1/46/23b146de2590aa125878c199826fd4c9.jpg" alt="more">
            </div>
            <div class="image">
              <img src="https://i.pinimg.com/236x/36/1d/cb/361dcbe28de6767413936281c53196fa.jpg" alt="more">
            </div>
            <div class="image">
              <img src="https://i.pinimg.com/236x/6f/9b/76/6f9b7649075dcd408038b3f65a9ab6c8.jpg" alt="more">
            </div>
            <div class="image">
              <img src="https://i.pinimg.com/236x/49/4a/a4/494aa4eefba402b5d199b77918c712d5.jpg" alt="more">
            </div>
            <div class="image">
              <img src="https://i.pinimg.com/236x/70/38/52/703852ee8f59cc845e3181baa728949b.jpg" alt="more">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <ul class="d-flex justify-content-between">
          <ul class="d-flex gap-2 ps-0">
            <li class="sm-mr1"><a aria-label="spotify" class="sb-iconButton relative inline-block" href="#"
                style="min-width:44px;min-height:44px"><svg aria-hidden="true" class="valign-middle absoluteCenter"
            ...
            <li class="sm-mr1"><a aria-label="facebook" class="sb-iconButton relative inline-block" href="#"
                style="min-width:44px;min-height:44px"><svg aria-hidden="true" class="valign-middle absoluteCenter"
                  focusable="false" preserveAspectRatio="xMidYMid meet"
                  style="width:32px;height:32px;overflow:visible;fill:currentColor" viewBox="0 0 24 24">
                  <path
            ...
            <li class="sm-mr1"><a aria-label="pinterest" class="sb-iconButton relative inline-block" href="#"
                style="min-width:44px;min-height:44px"><svg aria-hidden="true" class="valign-middle absoluteCenter"
                  focusable="false" preserveAspectRatio="xMidYMid meet"
                  style="width:32px;height:32px;overflow:visible;fill:currentColor" viewBox="0 0 24 24">
                  <path
            ...
            <li class="sm-mr1"><a aria-label="instagram" class="sb-iconButton relative inline-block" href="#"
                style="min-width:44px;min-height:44px"><svg aria-hidden="true" class="valign-middle absoluteCenter"
                  focusable="false" preserveAspectRatio="xMidYMid meet"
                  style="width:32px;height:32px;overflow:visible;fill:currentColor" viewBox="0 0 24 24">
                  <path
            ...
            <li class="sm-mr1"><a aria-label="youtube" class="sb-iconButton relative inline-block" href="#"
                style="min-width:44px;min-height:44px"><svg aria-hidden="true" class="valign-middle absoluteCenter"
                  focusable="false" preserveAspectRatio="xMidYMid meet"
                  style="width:32px;height:32px;overflow:visible;fill:currentColor" viewBox="0 0 24 24">
                  <path
            ...
            <li class="sm-mr1"><a aria-label="twitter" class="sb-iconButton relative inline-block" href="#"
                style="min-width:44px;min-height:44px"><svg aria-hidden="true" class="valign-middle absoluteCenter"
                  focusable="false" preserveAspectRatio="xMidYMid meet"
                  style="width:32px;height:32px;overflow:visible;fill:currentColor" viewBox="0 0 24 24">
                  <path
          ...
          <li><strong>Tel: </strong>(+84)000000000</li>
        ...
        <ul class="d-flex gap-3">
          ...
          <li class="d-flex gap-3"><span>|</span>
            <a href="#">
        ...
        <p class="mt-5">© 2023 aloTra Coffee Company. All rights reserved.</p>
      </div>
    </footer>
