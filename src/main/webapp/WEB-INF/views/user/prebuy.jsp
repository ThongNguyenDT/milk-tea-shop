...
<script>
    ...
    const handleElementClick = function (elements, event) {
        ...
        // Kiểm tra xem phần tử đã có trạng thái 'active' hay chưa
        if (clickedElement.classList.contains('active')) {
            // Nếu đã có, xóa trạng thái 'active'
            clickedElement.classList.remove('active');
        } else {
            // Nếu chưa có, thêm trạng thái 'active'
            toggleActiveClass(clickedElement);
            // Xóa trạng thái 'active' từ các phần tử khác
    ...
    for (let i = 0; i < svg1Elements.length; i++) {
