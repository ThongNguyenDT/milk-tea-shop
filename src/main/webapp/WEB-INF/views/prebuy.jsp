            ...
            <div class="col">
                <div class="cntt">
                    ...
                    <div class="Note" style="display: flex;">
                        <h1
                                style="font-family: Molengo, sans-serif; text-align: center;font-size: 35px; font-style: normal; font-weight: 400; line-height: normal; color: #000000; margin-left: 55px; margin-top:70px"> No
                            Note</h1>
                    </div>
                    <div class="Notebor">
